...
os.system(f"cd {code_dir}/utils && python sft_T5.py \
    ...
    --learning_rate 1e-3 \
    --save_path {code_dir}/outputs-sft-msmarco/{model}_{top_or_rand}_{scale}_{dataset}_{encoding}/ \
    ...
    --docid_path {code_dir}/resources/datasets/processed/msmarco-data/encoded_docid/t5_512_pq_{top_or_rand}.{scale}.txt \
    --train_file_path {code_dir}/resources/datasets/processed/msmarco-data/sft_training_datasets_pq \
