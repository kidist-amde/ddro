...
def main():
    ...
    os.system(f"cd {code_dir}/pretrain && python runT5.py \
        ...
        --learning_rate 1e-3 \
        --save_path {code_dir}/outputs-new/{load_model}_{top_or_rand}_{scale}_{encoding}_{all_data}/model_final.pkl \
        ...
        --docid_path {code_dir}/dataset/encoded_docid/t5_url_msmarco.txt \
