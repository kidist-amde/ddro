...
operation = "testing"
max_seq_length = 64
# other than url use the below settings
...
def main():
    ...
    os.system(f"""cd {code_dir}/utils && python runT5.py \
        ...
        --learning_rate 1e-3 \
        --save_path {code_dir}/outputs-nq/t5_128_10_url_title_pretrain/model_final.pkl \
        --log_path {code_dir}/logs-nq/{stage}.{model}.{encoding}.pretrain.log \
