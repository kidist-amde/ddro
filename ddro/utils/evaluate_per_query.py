...
class evaluator:
    ...
    def evaluate_ranking(self, docid_truth, all_doc_probs, doc_idxs=None, query_ids=None, match_scores=None):
        ...
        results_dict = {
            'MRR@10': mrr_10_list, 'MRR': mrr_list, 
            'NDCG@10': ndcg_10_list, 'NDCG@20': ndcg_20_list, 
            'NDCG@100': ndcg_100_list, 'MAP@20': map_list,
            'P@1': p_1_list, 'P@10': p_10_list, 
            'P@20': p_20_list, 'P@100': p_100_list,
            'R@1': r_1_list, 'R@10': r_10_list, 
            'R@100': r_100_list, 'R@1000': r_1000_list,
            'Hit@1': hit_1_list, 
            'Hit@5': hit_5_list,
            'Hit@10': hit_10_list, 'Hit@100': hit_100_list
        }
