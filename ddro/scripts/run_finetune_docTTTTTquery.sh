...
DATASET_PATH=resources/datasets/processed/nq-data/nq-merged/nq_merged.tsv.gz
OUTPUT_FILE=resources/datasets/processed/nq-data/nq-merged/query_document_pairs.tsv.gz
