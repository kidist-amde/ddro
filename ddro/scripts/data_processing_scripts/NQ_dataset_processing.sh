#!/bin/sh
#SBATCH --job-name=nq_dataset_split           
#SBATCH --ntasks-per-node=1
#SBATCH --time=4-00:00:00 # d-h:m:s
#SBATCH --mem=128gb # memory per job
#SBATCH -c 16 # number of CPUs
#SBATCH --output=logs-slurm/other-logs/nq_extract_and_split_nqdataset-%j.out # %j is the job ID
...
OUTPUT_FILE="resources/datasets/processed/nq-data/nq-merged/nq_merged.tsv"
