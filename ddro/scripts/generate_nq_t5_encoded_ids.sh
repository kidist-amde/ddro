...
#SBATCH --output=logs-slurm/other-logs/generate_nq_atomic_ids-%j.out # %j is the job ID
...
NQ_DATA_PATH=resources/datasets/raw/nq-data/nq_merged.tsv.gz # pass this for atomic and URL-based document IDs

# Run the Python script
python data/data_preprocessing/generate_nq_t5_encoded_docids.py \
                --encoding $ENCODING \
