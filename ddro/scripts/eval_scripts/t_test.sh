...
#SBATCH --output=log-SIGNIFICANCETEST/other-logs/t_test_sft_vs_ddro_pq-%j.out # %j is the job ID
...
model2="DDRO"
encoding="pq"  # pq or atomic or url_title
dataset="msmarco"  # msmarco or nq
folder_path="log-SIGNIFICANCETEST"
...
python utils/statistical_tests.py \
    --metrics_file1 log-SIGNIFICANCETEST/DDRO-msmarco-pq.csv \
    --metrics_file2 log-SIGNIFICANCETEST/SFT-msmarco-pq.csv \
