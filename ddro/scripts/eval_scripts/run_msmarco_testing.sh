#!/bin/sh
#SBATCH --job-name=Eval_pretrain_search_finetune_pq_msmarco_ULTRON
...
#SBATCH -c 16
#SBATCH --output=logs-slurm/eval-logs/Eval_pretrain_search_finetune_pq_msmarco_ULTRON-%j.out # %j is the job ID
