#!/bin/sh
#SBATCH --job-name=EVal_SFT-msmarco-atomic  # Job name
...
#SBATCH --output=logs-slurm-ultron/Eval_ULTRON-MSMARCO-atomic_logs_10_BEAM-%j.out # Log output with unique job ID
