...
##SBATCH --output=logs-slurm-BM25/msmarco_dataset_BM25_Index_Creation-%j.out # %j is the job ID
##SBATCH --output=logs-slurm-BM25/msmarco_dataset_BM25_retrieval_bm25_train_top_1000k-%j.out # %j is the job ID
##SBATCH --output=logs-slurm-BM25/msmarco_dataset_BM25_retrieval_bm25_dev_top_1000k-%j.out # %j is the job ID
#SBATCH --output=logs-slurm-BM25/msmarco_dataset_BM25_retrieval_EVAL_Train_top_1000k-%j.out # %j is the job ID
