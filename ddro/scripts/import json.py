...
def main():
    ...
    #     eval_steps=1000,
    #     num_train_epochs=5,
    #     learning_rate=1e-5, #1e-6s, 1e-5
    #     evaluation_strategy="steps",
    #     load_best_model_at_end=True
    # )
    training_args = DPOConfig(
    output_dir=cli_args.output_dir,
    per_device_train_batch_size=16,  # Or try increasing/decreasing
    save_total_limit=2,
    save_steps=1000,
    eval_steps=500,  # Evaluate more frequently to monitor progress
    num_train_epochs=7,  # Consider increasing to 6 or 7
    ...
    #     model_ref,
    #     args=training_args,  
    #     beta=1.0,  # Experiment with lower or higher beta values
    #     train_dataset=train_dataset,
    #     eval_dataset=dev_dataset,
    #     tokenizer=tokenizer,
    #     is_encoder_decoder=True,
