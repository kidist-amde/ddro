...
#SBATCH --output=logs-slurm-summaries/generate_three_stage_msmarco_summary_eval_data-%j.out # %j is the job ID
...
ENCODING="summary"  # 'atomic' or 'pq' or 'atomic' or 'summary'
