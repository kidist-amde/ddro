#!/bin/sh
#SBATCH --job-name=EVal_ddro-MS-URL # Job name
...
#SBATCH --output=logs-slurm-ultron-msmarco/Eval_DDRO_URL_MSmarco__5_BEAMSIZE_3epoch_lr5e-6_NEWTRIPLS_logs-%j.out # Log output with unique job ID
...
python utils/test_dpo_run_query_metrics_msmarco.py \
                --encoding url
